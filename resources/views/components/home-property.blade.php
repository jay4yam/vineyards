<div data-aos="fade-up"
    ...
    <div class="transition ease-in-out delay-100 hover:brightness-75 h-full">
        <img class="group-hover:blur-sm group-hover:scale-110 group-hover:duration-300 w-full object-cover" src="{{ asset('storage/properties/'.$property->reference.'/'.$property->picture->name) }}" alt="{{ $property->name }}"/>
    </div>
