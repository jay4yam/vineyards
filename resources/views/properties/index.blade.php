<x-front-layout :seoData="$seoData">
    ...
    <header class="relative flex items-center justify-center h-32 lg:h-96 w-full" style="background: center/cover fixed url('{{ asset('images/bg-listing.webp') }}');">
        <div class="w-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 drop-shadow text-center">
    ...
    <div class="flex items-center justify-between container mx-auto px-4 lg:px-40 py-4">
        ...
        <form action="{{ route('properties.index') }}" class="text-gray-400 hidden lg:block w-1/2">
